# Primer Design Methods: Spizellomycetaceae
...
**Input:** 52 aligned sequences
**Output:** Consensus sequence (see `Spizellomycetaceae_consensus.fasta`)
...
```bash
primer3_core << EOF
SEQUENCE_ID=Spizellomycetaceae
...
**Best Primer Pair:**
- Forward: `CTCATCCGAAACGCTGCATG`
- Reverse: `TTGGCTGCGGATTACCCATT`
- Product Size: 450 bp
- Forward Tm: ~60°C
- Reverse Tm: ~60°C
...
See `Spizellomycetaceae_primers.json` for all primer pairs with detailed statistics.

## Quality Metrics

Primers were selected based on:
1. Melting temperature (Tm) close to 60°C
2. GC content between 40-60%
3. No significant secondary structures
4. Product size within 200-800 bp range
5. Low penalty score (primer3 optimization)
