# Primer Design Methods: Spizellomyces
...
**Output:** Consensus sequence (see `Spizellomyces_consensus.fasta`)
...
- Reverse Tm: 60.0°C, GC: 50%

**Total Primer Pairs Designed:** 5

See `Spizellomyces_primers.json` for all primer pairs with detailed statistics.
