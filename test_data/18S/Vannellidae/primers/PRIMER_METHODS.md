# Primer Design Methods: Vannellidae
...
**Output:** Consensus sequence (see `Vannellidae_consensus.fasta`)
...
See `Vannellidae_primers.json` for all primer pairs with detailed statistics.
