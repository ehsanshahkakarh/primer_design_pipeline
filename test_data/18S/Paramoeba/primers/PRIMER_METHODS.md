# Primer Design Methods: Paramoeba
...
**Input:** 20 aligned sequences
**Output:** Consensus sequence (see `Paramoeba_consensus.fasta`)
...
**Best Primer Pair:**
- Forward: `CGGGGAAACTTACCAGGACC`
- Reverse: `TGTGTACAAAGGGCAGGGAC`
- Product Size: 590 bp
- Forward Tm: 60.0°C, GC: 60%
- Reverse Tm: 59.9°C, GC: 55%

**Total Primer Pairs Designed:** 5

See `Paramoeba_primers.json` for all primer pairs with detailed statistics.
