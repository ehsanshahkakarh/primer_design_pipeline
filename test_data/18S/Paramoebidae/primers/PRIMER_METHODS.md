# Primer Design Methods: Paramoebidae
...
**Input:** 54 aligned sequences
**Output:** Consensus sequence (see `Paramoebidae_consensus.fasta`)
...
**Best Primer Pair:**
- Forward: `GGCCGTTCTTAGTTGGTGGA`
- Reverse: `GGGCAGGGACGTAATCAACA`
- Product Size: 575 bp
...
See `Paramoebidae_primers.json` for all primer pairs with detailed statistics.
